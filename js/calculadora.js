...
function subtrair() {
    ...
    document.getElementById("resultadoSub").innerHTML = "Resultado: " + resultado;
...
function multiplicar() {
    ...
    document.getElementById("resultadoMult").innerHTML = "Resultado: " + resultado;
...
function dividir() {
    ...
    document.getElementById("resultadoDiv").innerHTML = "Resultado: " + resultado;
